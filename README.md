# Tiny Admin - 模块化中后台管理系统

## 项目介绍

Tiny Admin 是一个基于 Spring Boot 3 + MyBatis Plus + Sa-Token + React + Ant Design 构建的模块化中后台管理系统。采用多模块设计,便于后期维护和功能扩展。
...
├── tiny-admin-core/            # 核心模块
│   ├── security/               # 登录用户信息
│   ├── config/                 # Sa-Token配置、Redis配置
│   └── utils/                  # 登录用户工具类
├── tiny-admin-system/          # 系统管理模块
...
2. 修改配置文件 `tiny-admin-admin/src/main/resources/application.yml`
```yaml
spring:
  datasource:
