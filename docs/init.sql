...
('用户新增', 2, 1, NULL, NULL, 'F', '0', '0', 'system:user:add', NULL),
('用户修改', 2, 2, NULL, NULL, 'F', '0', '0', 'system:user:edit', NULL),
('用户删除', 2, 3, NULL, NULL, 'F', '0', '0', 'system:user:remove', NULL),
('角色新增', 3, 1, NULL, NULL, 'F', '0', '0', 'system:role:add', NULL),
('角色修改', 3, 2, NULL, NULL, 'F', '0', '0', 'system:role:edit', NULL),
('角色删除', 3, 3, NULL, NULL, 'F', '0', '0', 'system:role:remove', NULL),
('菜单新增', 4, 1, NULL, NULL, 'F', '0', '0', 'system:menu:add', NULL),
('菜单修改', 4, 2, NULL, NULL, 'F', '0', '0', 'system:menu:edit', NULL),
('菜单删除', 4, 3, NULL, NULL, 'F', '0', '0', 'system:menu:remove', NULL);
